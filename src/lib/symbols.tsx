...
// viewBox dimensions. preserveAspectRatio="none" so templates can place them at
// any width/height and the interior detail scales naturally along each axis.
...
const SofaSectional: React.FC<SymbolProps> = (p) => (
  <SvgVB {...p} vbW={220} vbH={180}>
    <path d="M4 4 H216 V70 H80 V176 H4 Z" strokeLinejoin="miter" />
    <path d="M14 14 H206 V60 H70 V166 H14 Z" fill="none" strokeLinejoin="miter" />
...
const OfficeBooth: React.FC<SymbolProps> = (p) => (
  <SvgVB {...p} vbW={90} vbH={100}>
    <path d="M4 96 V4 H86 V96" fill="none" strokeLinejoin="miter" />
